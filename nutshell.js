{
    ...
    Nutshell.language = {
        en: {
            ...
            // Button text
            closeAllNutshells: `chiudi tutto`,
            ...
            // Embed modal!
            embedStep0: `Puoi inserire questa spiegazione nel tuo sito web!
		...
		it: {
            ...
            // Button text
            closeAllNutshells: `cerrar todos`,
            ...
            // Embed modal!
            embedStep0: `Puoi inserire questa spiegazione espandibile nel tuo sito web!
    ...
    document.Nutshell.closeAllButton.style.backgroundColor = "#000000";
            ...
            if(_isWikipedia(url)){
                ...
                setTimeout(()=>{
                    rejectPurifiedHTML(
                        ...
                        <a class="a" target='_blank' href='${url}'>${url}</a>
                        </p>`
                    );
                },LOAD_WAIT_TIME);
    ...
    let _addSource = (url)=>{
        if(url == Nutshell.thisPageURL){
            ...
            return `<p class='nutshell-bubble-from'> from <a class="a" target='_blank' href='${url}'>${urlSansProtocol}</a></p>`
        }
    }
    ...
    Nutshell.fillEmbedModalText = ()=>{
        ...
        // (Learn More)
        _p4.innerHTML = `<a class="a" href='https://ncase.me/nutshell/' target='_blank'>` +
    ...
    Nutshell.showEmbedModal = (url, linkText)=>{
        ...
        _p0.innerHTML = Nutshell.getLocalizedText("embedStep0")
            .replace(`[EXAMPLE]`,`<a class="a" href='${url}' style='font-weight:bold'>:${linkText}</a>`);
